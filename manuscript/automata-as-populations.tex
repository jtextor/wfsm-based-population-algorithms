...
We have implemented our WFSM-based algorithms in C++, making heavy use of the library OpenFST \cite{openfst}. Our code is available for download at \url{}.
...
For an input sequence  $S=(s_1,\ldots,s_n)$, $S \subseteq \mathcal{U}^n$,
...
\begin{figure}[t]
  \centering
	%\includegraphics{figures/figure-string-distinction/plots/analysis.pdf}
   \includegraphics[width=\textwidth]{figures/figure-lang-distinction/plots/fig4.pdf}
   \caption{ 
...
\begin{figure}[t]
  ...
  \begin{tabular}{p{5pt}@{}cp{5pt}@{}c}
    \raisebox{-\height}{A} & %
    \multicolumn{3}{c}{\raisebox{-\height}{\includegraphics{figures/figure-genetic-algorithms/plots/constraints-over-time.pdf}}} \\
    \raisebox{-\height}{B} & %
    \raisebox{-\height}{\includegraphics{figures/figure-genetic-algorithms/plots/populationsize-over-time.pdf}} & %
      \raisebox{-\height}{C} & %
      \raisebox{-\height}{\includegraphics{figures/figure-genetic-algorithms/plots/evaluations-over-time.pdf}}
  \end{tabular}
  \endgroup
  \caption{
